...
Castling Move::is_castling()       const { return static_cast<Castling>((data >> 21) & 0x2);  }
...
Castling Move::castle_rights()     const { return static_cast<Castling>((data >> 30) & 0x2);  }
BB       Move::en_passant_status() const { return static_cast<BB>(get_BB(data >> 24) & 0x3F); }
